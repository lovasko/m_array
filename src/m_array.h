...
int m_array_init(struct m_array* array, size_t initial_length, size_t object_size);
...
int m_array_set(struct m_array* array, size_t index, size_t object_count, void* data);
...
int m_array_insert(struct m_array* array, size_t index, size_t object_count, void* data);
